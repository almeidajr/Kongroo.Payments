...
namespace Kongroo.Payments.Infrastructure.Migrations
{
    ...
    public partial class AddMassTransitOutbox : Migration
    {
        ...
        {
            migrationBuilder.DropTable(name: "outbox_message", schema: "payments");

            migrationBuilder.DropTable(name: "inbox_state", schema: "payments");

            migrationBuilder.DropTable(name: "outbox_state", schema: "payments");
